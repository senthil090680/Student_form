  ...
  <tr>
    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="5%" align="left" valign="middle" class="txt"><div class="txt"><a href="#">Delete</a></div></td>
...
function pageactivity(pageno){
        ...
        //window.location =  "search.php?page="+pageno;
}
...
$query                                  =               "SELECT COUNT(*) as totalPages FROM register_table WHERE $field LIKE'%$find%'";
...
$dataquery				=		"SELECT * from register_table WHERE $field LIKE'%$find%' order by id asc LIMIT $start, $limit";
...
<?php
 ...
 //$dataresquery = mysql_query("SELECT * FROM register_table WHERE $field LIKE'%$find%' "); 
